...
namespace Ultima3CharacterEditor
{
    public class Ultima3Doc
    {
        ...
        public byte posY { get; set; }   // Player position in the sosaria map
        public uint steps { get; set; }        // # steps

        public byte status { get; set; }        // Party Status, 0
        ...
        public static string[] tileName = new string[] {
            ...
            "mountain","dungeon","town","castle",
            "street","chest","horse","frigate",
            "whirlpool","serpent","octopus","pirate",
            "merchant","lark","guard","LB",
            "fighter","cleric","wizard","thief",
            "troll","skeleton","golem","gargoyle",
            "snatch","griffin","devil","exodus",
            "forcefield","lava","moongate","wall",
            "blank","letter_space","letterA","letterB",
            "letterC","letterD","letterE","letterF",
            "letterG","letterH","letterI","letterV",
        ...
        public class Spell
        {
            ...
            public Spell(string type, string key, string name, int point, string desc)
                {
                    this.type = type;
                    this.key = key;
                    this.name = name;
        ...
        public static ArrayList spellData = new ArrayList()
        {
            new Spell("wizard", "A", "Repond", 0, "May kill each orc, troll, or goblin; can be used once per battle"),
            new Spell("wizard", "B", "Mittar", 5, "Damage an enemy with a ranged attack"),
            new Spell("wizard", "C", "Lorum", 10, "Create light like Ignite"),
            new Spell("wizard", "D", "Dor Acron", 15, "Move to the same location one dungeon level below"),
            new Spell("wizard", "E", "Sur Acron", 20, "Move to the same location one dungeon level above"),
            new Spell("wizard", "F", "Fulgar", 25, "Damage an enemy more with a ranged attack"),
            new Spell("wizard", "G", "Dag Acron", 30, "Teleport to a random spot in the world"),
            new Spell("wizard", "H", "Mentar", 35, "Damage an enemy based on Int with a ranged attack"),
            new Spell("wizard", "I", "Dag Lorum", 40, "Create light like Ignite, lasts longer"),
            new Spell("wizard", "J", "Fal Divi", 45, "Cast a cleric spell (requires separate MP for that spell)"),
            new Spell("wizard", "K", "Noxum", 50, "Damage all enemies"),
            new Spell("wizard", "L", "Decorp", 55, "Attempts to kill an enemy with a ranged attack"),
            new Spell("wizard", "M", "Altair", 60, "Stops time like Negate"),
            new Spell("wizard", "N", "Dag Mentar", 65, "Damage all enemies based on Int"),
            new Spell("wizard", "O", "Necorp", 70, "Damage all enemies more"),
            new Spell("wizard", "P", "(no name)", 75, "Attempts to kill each foe"),
            new Spell("cleric", "A", "Pontori", 0, "May kill all skeletons, ghouls, and zombies; can be used once per battle"),
            new Spell("cleric", "B", "Appar Unem", 5, "Like Get a chest, but without fear of traps"),
            new Spell("cleric", "C", "Sanctu", 10, "Recover one party member's HP"),
            new Spell("cleric", "D", "Luminae", 15, "Create light like Ignite"),
            new Spell("cleric", "E", "Rec Su", 20, "Move to the same location one dungeon level above"),
            new Spell("cleric", "F", "Rec Du", 25, "Move to the same location one dungeon level below"),
            new Spell("cleric", "G", "Lib Rec", 30, "Move to a random spot on the same dungeon level"),
            new Spell("cleric", "H", "Alcort", 35, "Cures one party member of Poisoned status"),
            new Spell("cleric", "I", "Sequitu", 40, "Return to the dungeon entrance"),
            new Spell("cleric", "J", "Sominae", 45, "Create light like Ignite, lasts longer"),
            new Spell("cleric", "K", "Sanctu Mani", 50, "Recover more of one party member's HP"),
            new Spell("cleric", "L", "Vieda", 55, "View map like Peer"),
            new Spell("cleric", "M", "Excuun", 60, "Attempts to kill an enemy with a ranged attack"),
            new Spell("cleric", "N", "Surmandum", 65, "Cures Dead status, but may causes Ashes instead"),
            new Spell("cleric", "O", "Zxkuqyb", 70, "Attempts to kill each foe"),
            new Spell("cleric", "P", "Anju Sermani", 75, "Cures Ashes status, costs caster 5 Wisdom permenently")  
        };
